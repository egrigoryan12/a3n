...
public class Game extends Form implements Runnable {
    ...
    public Game(){
        ...
        BorderLayout borderLayoutForm = new BorderLayout();
        ...
        add(BorderLayout.CENTER, redContainer);
        ...
        AccelerateCommand accelerateCommandWest = new AccelerateCommand(gw);
        leftSide.setCommand(accelerateCommandWest);
        ...
        BrakeCommand brakeCommandEast = new BrakeCommand(gw);
        rightSide.setCommand(brakeCommandEast);
